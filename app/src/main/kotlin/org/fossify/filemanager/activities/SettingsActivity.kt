...
class SettingsActivity: SimpleActivity() {
	...
	override fun onResume() {
		...
		binding.apply {
			arrayOf(settingsColorCustomizationSectionLabel, settingsGeneralSettingsLabel, settingsVisibilityLabel, settingsScrollingLabel,
				settingsFileOperationsLabel, settingsSecurityLabel).forEach {
	...
	private fun setupFontSize() {
		...
		binding.settingsFontSizeHolder.setOnClickListener {
			val items = arrayListOf(RadioItem(FONT_SIZE_SMALL, getString(org.fossify.commons.R.string.small)),
